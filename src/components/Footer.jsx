...
const Footer = () => {
    return (
        <>
            <section className='p-12 h-full space-y-8 bg-[#f7f7f7] text-white flex'>
                <div
                    className='text-black text-start space-y-8 w-[50%] flex justify-center flex-col'
                >
                ...
                <div className='w-[50%] '>
                    <img src={g} className='h-[30rem] rounded' alt="" />
                </div>
            </section>
        </>
    )
